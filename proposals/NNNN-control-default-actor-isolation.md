...
This would be limited to build settings that make sense on individual files. For example, `-enable-library-evolution` must be set for the entire module and cannot be set per file.
