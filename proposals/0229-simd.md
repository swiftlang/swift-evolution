...
public extension SIMDMask {
  ...
  static func .&(lhs: Scalar, rhs: SIMDMask) -> SIMDMask
  static func .^(lhs: Scalar, rhs: SIMDMask) -> SIMDMask
  static func .|(lhs: Scalar, rhs: SIMDMask) -> SIMDMask
  
  static func .&(lhs: SIMDMask, rhs: Scalar) -> SIMDMask
  static func .^(lhs: SIMDMask, rhs: Scalar) -> SIMDMask
  static func .|(lhs: SIMDMask, rhs: Scalar) -> SIMDMask
  ...
  static func .&=(lhs: inout SIMDMask, rhs: Scalar)
  static func .^=(lhs: inout SIMDMask, rhs: Scalar)
  static func .|=(lhs: inout SIMDMask, rhs: Scalar)
...
shorter, which is an nice benefit, and they now have a uniform `SIMD` prefix.
  ...
  | Old name | New name |
  | --- | --- |
  | `Vector2<Scalar>` | `SIMD2<Storage>` |
  | `Vector3<Scalar>` | `SIMD3<Storage>` |
  | `Vector4<Scalar>` | `SIMD4<Storage>` |
  | `Vector8<Storage>` | `SIMD8<Storage>` |
  | `Vector16<Storage>` | `SIMD16<Storage>` |
  | `Vector32<Storage>` | `SIMD32<Storage>` |
  | `Vector64<Storage>` | `SIMD64<Storage>` |
