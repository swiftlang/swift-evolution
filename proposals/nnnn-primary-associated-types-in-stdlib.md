...
| `DistributedActor`                                   | `ActorSystem`              | `ID`, `SerializationRequirement`                                                                                                                                                                                     |
| `DistributedActorSystem`                             | `SerializationRequirement` | `ActorID`, `InvocationEncoder`, `InvocationDecoder`, `ResultHandler`                                                                                                                                                 |
